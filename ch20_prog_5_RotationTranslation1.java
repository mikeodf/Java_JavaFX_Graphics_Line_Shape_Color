// RotationTranslation1.java
/*
First rotate the objects, then translate them
...
public class RotationTranslation1 extends Application { 
   ...
   public void start(Stage stage) {  
     ...
     //FIRST: Execute rotation to circle2, rect3,  rect4 
      ...
      stage.setTitle("Rotation followed by Translation transformation"); 
